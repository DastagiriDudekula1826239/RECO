...
import pickle
import numpy as np
from two_hop_att.UserUserUpdater import UserUserUpdater
from two_hop_att.UserUserAggregator import UserUserAggregator

from two_hop_att.UserItemOpinionConsider import UserItemOpinionConsider

from pyjavaproperties import Properties

from two_hop_att.GnnSocialRecommendationSystem import GnnSocialRecommendationSystem
...
def main():
    ...
    user_user_updater = UserUserUpdater(lambda nodes: opinionT(nodes).t(), user_to_users_social_adjacency,
                                        user_user_aggregator, user_embeddings, embeddig_dim, userFeatsUVFlag,
                                        cuda=device)
