...
class UserUserUpdater(nn.Module):
    ...
    def __init__(self, uv_updated_embeddings, user_to_users_social_adjacency, aggregator, embeddig_dim, userFeatsUVFlag="False", cuda="cpu"):
    ...
    def forward(self, nodes):
        ...
        for node in nodes:
            ...
            self_feats_first = self_feats_first.t()
